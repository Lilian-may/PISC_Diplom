namespace Pipe
{
    partial class ImportPipelinesForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.titleLabel.Text = "Импорт трубопроводов";
            ...
            instructionDetails.Text = "name, start_km, end_km, diameter_mm, wall_thickness_mm, steel_grade, yield_strength_mpa, design_pressure_mpa, operating_pressure_mpa, region, commissioning_date";
